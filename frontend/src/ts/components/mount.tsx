...
import { KineticContainer } from "./pages/test/kinetic/KineticContainer";
...
import { TrainingSidebar } from "./pages/test/TrainingSidebar";
...
const components: Record<string, () => JSXElement> = {
  ...
  kineticcontainer: () => <KineticContainer />,
};
